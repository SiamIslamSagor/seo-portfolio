...
const TypewriterHero = () => {
  ...
  const texts = [
    "Remove Negative Content & Suppress Harmful Search Results",
    "Rebuild Trust. Restore Credibility. Protect Your Name.",
    "Protect Your Online Reputation Before It’s Too Late",
    "Rebuild Trust With Strategic ORM Solutions",
    "Restore Your Brand’s Credibility Across the Web",
  ];
  // Typewriter effect
  useEffect(() => {
    ...
    const timeout = setTimeout(
      ...
      isDeleting ? getRandomDelay(30) : getRandomDelay(80)
          ...
          <div className="order-1">
            <div className="space-y-6 ">
                ...
                <div className="h-24 sm:h-28 flex items-center">
                  <h1 className="text-2xl sm:text-3xl font-bold text-theme-primary leading-tight">
                    <span className="block typewriter-text">
                      {displayText}
                      <span className="inline-block w-0.5 h-6 sm:h-7 lg:h-8 bg-theme-accent ml-1 typewriter-cursor"></span>
                    </span>
                  </h1>
                </div>
              ...
              <p className="text-lg text-theme-secondary leading-relaxed max-w-2xl">
                I offer a personal – tailored ORM approach, your brand isn’t
                just another client. With expert insight and a proven ORM
                strategy, think of me as your go-to ORM specialist, committed to
              ...
              <div className="flex items-center space-x-6">
                ...
                <div className="flex space-x-3">
                  ...
                  <a
                    href="mailto:sumon@ormspecialist.com"
                    className="w-10 h-10 bg-theme-background-alt rounded-full flex items-center justify-center hover:bg-theme-accent hover:text-theme-white transition-all duration-300 group"
                  >
              ...
              {/* Trust Indicators */}
              <div className="flex flex-wrap items-center gap-2 md:gap-8 lg:gap-5 pt-8 border-t border-theme-border-light">
                <div className="flex items-center space-x-3 lg:space-x-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-theme-secondary text-sm">
                    100+ Reputation Issues Resolved
                  </span>
                </div>
                <div className="flex items-center space-x-3 lg:space-x-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-theme-secondary text-sm">
                    92% Success Rate in SERP Suppression
                  </span>
                </div>
                <div className="flex items-center space-x-3 lg:space-x-2">
                  <div className="w-2 h-2 bg-green-500 rounded-full"></div>
                  <span className="text-theme-secondary text-sm">
                    Trusted by CEOs, Founders & Public Figures
                  </span>
                </div>
              </div>
            </div>
                ...
                <div className="bg-theme-background rounded-xl p-6 space-y-6">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-theme-background-alt rounded-lg p-4 text-center">
                      ...
                      <div className="text-sm text-theme-secondary">
                        Response Time to Reputation Crises
                      </div>
                    </div>
                    <div className="bg-theme-background-alt rounded-lg p-4 text-center">
                      <div className="text-2xl font-bold text-theme-accent">
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                      {[
                        ...
                        >
                          <span className="text-xs text-theme-secondary w-12">
                            {el.text}
                          </span>
